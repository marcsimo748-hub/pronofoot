    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-black">Scores & Matchs en Direct</h1>
            <p className="text-slate-400 text-sm">Suivi des 19 clubs d'élite et de la Ligue des Champions.</p>
          </div>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center flex flex-col items-center justify-center min-h-[300px]">
          <Calendar className="w-16 h-16 text-emerald-400 mb-4 opacity-80" />
          <h2 className="text-xl font-bold mb-2">Synchronisation en attente</h2>
          <p className="text-slate-400 text-sm max-w-md">
            Les matchs de la saison 2026/2027 s'afficheront ici dès que la synchronisation avec Supabase sera lancée.
          </p>
        </div>
      </div>
    </main>
