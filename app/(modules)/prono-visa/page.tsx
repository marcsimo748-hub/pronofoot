...
export const metadata: Metadata = {
  title: "PRONO Visa, Calcule tes chances de visa Allemagne",
  description:
    "Calculateur de chances de visa Allemagne (Ausbildung, Studium, Chancenkarte, travail, tourisme) : score d'estimation, checklist des documents et guides complets. Gratuit, par PRONO.",
};
