      ...
      <div className="container grid gap-8 py-10 md:grid-cols-3">
        <div>
          <Link href="/" className="flex items-center gap-2" aria-label="PRONO, retour à l'accueil">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-primary/15 font-black text-lg text-gradient">P.</span>
      ...
      <div className="border-t border-white/5 py-4">
        <div className="container space-y-2 text-center">
          ...
          <p className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-muted-foreground">
            <a href="https://wa.me/4915754169524" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 hover:text-primary">
              <MessageCircle className="h-3 w-3" /> +49 1575 4169524
            </a>
            <span className="flex items-center gap-1">
              📲 WhatsApp & Telegram · messages uniquement
            </span>
            ...
            <Link href="/soutenir" className="flex items-center gap-1 hover:text-primary">
              <Coffee className="h-3 w-3" /> Soutenir ☕
            </Link>
            <Link href="/partenaires" className="flex items-center gap-1 hover:text-primary">
              <Store className="h-3 w-3" /> Devenir partenaire
            </Link>
            <Link href="/boutique" className="flex items-center gap-1 hover:text-primary">
              <Shirt className="h-3 w-3" /> Boutique 👕
            </Link>
            <Link href="/boutiques" className="flex items-center gap-1 hover:text-primary">
              <Store className="h-3 w-3" /> Boutiques membres
            </Link>
          </p>
        </div>
      </div>
